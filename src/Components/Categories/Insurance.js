...
//viser alle rabatkouponer, der har kategorien Insurance

  
function InsuranceCoupons() {

  //navigation sørger for at vi kan navigere til siden ved tryk af en knap på Home siden
  const navigation = useNavigation();
    
  //filtrer til kategorien Insurance
  let couponsArr = coupons.filter(coupon => coupon.category === 3)
...
export default InsuranceCoupons;