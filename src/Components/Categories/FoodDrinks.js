...
//viser alle rabatkouponer, der har kategorien Food & Drinks

  
function FoodDrinksCoupons() {

  //navigation sørger for at vi kan navigere til siden ved tryk af en knap på Home siden
  const navigation = useNavigation();
    
  //filtrer til kategorien Food&Drinks
  let couponsArr = coupons.filter(coupon => coupon.category === 4)
...
export default FoodDrinksCoupons;